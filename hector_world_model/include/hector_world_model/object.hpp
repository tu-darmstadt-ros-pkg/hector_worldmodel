...
public:
  Object( const ObjectCandidate &candidate )
  ...
  static std::map<std::string, int> class_counts_;
...
{
public:
  ObjectCandidate( const ObjectDetection &detection )
      : header_( detection.header_ ), class_name_( detection.class_name_ ),
        ...
        covariance_( detection.covariance_ )
  {
  }
...
{
public:
  ObjectDetection( const hector_perception_msgs::msg::ObjectDetection2D &msg )
